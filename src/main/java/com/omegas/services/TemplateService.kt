...
import com.omegas.util.functions.copyImage
...
object TemplateService {
    ...
    private fun getImageInTemplate(input: BufferedImage, dimension: Dimension): BufferedImage {
    ...
    private fun getShortenedImages(image: BufferedImage): MutableList<BufferedImage> {
